...
{
    public class RateableProduct11Adapter : Components.Rate11.Interfaces.IRateableProduct
    {
        private readonly RateableProductViewModel rateableProductViewModel;

        public RateableProduct11Adapter(RateableProductViewModel rateableProductViewModel)
        {
